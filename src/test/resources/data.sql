...
insert into meals(id,calories_in_kcal,ingredients) values
					('dc9f8bbd-daf2-4b3d-bccb-3c32e02ca9f7',1000,'Palta y Atún'),
					...
					('16d49d12-a5d5-4bd4-be4b-5a67379b5e8a',1350,'Atun y huevo'),
					('56a6b9d9-a0c6-4a43-9f03-5b4c65b02ae5',1600,'Pescado y beterraga'),
...
insert into users(id, email, email_validated, last_access_on, password, registered_on, status_code, role_id) values
				('366b5071-9eaf-4356-9ccf-9fe5b5a4d2c8','admin@user.com', true, '20200101', '$2y$10$uIgID8e4NIKuddGCHLeCM.u7fhw7O7oALKcEmQD1XaaJ1ikTNL0gW', '20200101', 0, 1);
...
insert into customers(id, first_name, last_name, user_id) values
				('3369cf8c-9a25-4355-a6cf-91a5355de96b','John','Doe',null),
				('8b7c06dc-1160-4256-a77c-3e0569ded556','Juan', 'Pérez', null);